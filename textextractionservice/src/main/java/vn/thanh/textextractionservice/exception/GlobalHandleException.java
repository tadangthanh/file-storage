package vn.thanh.textextractionservice.exception;
...
public class GlobalHandleException extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({CustomBlobStorageException.class, JsonSerializeException.class,CustomIOException.class})
    ...
    @ExceptionHandler({UploadFailureException.class, PropertyReferenceException.class,BadRequestException.class})
